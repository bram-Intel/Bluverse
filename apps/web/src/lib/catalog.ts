...
export const CATALOG_SERVICES: ServiceCategory[] = [
  {
    ...
    tiers: [
      {
        id: 'vps-1',
        name: 'Cloud VPS 1-2GB',
        badge: 'Dev & Microservices',
        specs: {
          cpu: '1 vCPU (AMD EPYC™)',
          ram: '2 GB DDR4 RAM',
          storage: '40 GB Gen4 NVMe',
        ...
        pills: ['1-2GB', '32TB TRAFFIC', 'INSTANT'],
        priceNgn: 14500,
        priceUsd: 9.50,
        billingPeriod: 'month',
        whmcsPid: 101,
