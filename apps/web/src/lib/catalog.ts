...
export const CATALOG_SERVICES: ServiceCategory[] = [
    ...
    tiers: [
      {
        ...
        specs: {
          ...
          bandwidth: '32 TB Outbound Traffic',
          sla: '99.9% Uptime SLA',
          features: ['Full Root & SSH Access', 'Automated Daily Snapshots', '1 Dedicated IPv4 + /64 IPv6', 'Instant Auto-Provisioning'],
        },
        pills: ['8GB RAM', '4 vCPU', 'NVMe GEN4'],
        priceNgn: 12999,
        priceUsd: 8.99,
        billingPeriod: 'month',
        whmcsPid: 1,
      },
      {
        ...
        pills: ['12GB RAM', '6 vCPU', 'NVMe GEN4'],
        priceNgn: 18999,
        priceUsd: 12.99,
        billingPeriod: 'month',
        whmcsPid: 2,
      },
      {
        ...
        specs: {
          cpu: '8 vCPU Cores',
          ram: '24 GB High-Speed RAM',
          storage: '300 GB NVMe Gen4 Storage',
          bandwidth: '32 TB Outbound Traffic',
          sla: '99.9% Uptime SLA',
          features: ['Full Root & SSH Access', 'Dedicated Core Allocation', 'Windows / Linux License Ready', 'Priority Enterprise Support'],
        },
        pills: ['24GB RAM', '8 vCPU', 'ENTERPRISE'],
        priceNgn: 33999,
        priceUsd: 22.99,
        billingPeriod: 'month',
        whmcsPid: 3,
  ...
  },
  {
    ...
    pills: ['LITE', 'PLUS', 'TURBO', 'UNLIMITED'],
    ...
    tiers: [
      {
        ...
        specs: {
          cpu: '1 Shared Core',
          ram: '512 MB Cloud Memory',
          storage: '5 GB Pure NVMe',
          bandwidth: 'Unmetered Traffic',
          sla: '99.9% SLA',
          features: ['1 Hosted Website', '5 Professional Business Emails', 'Free AutoSSL Certificate', 'cPanel & Webmail Access', 'WordPress 1-Click Install'],
        },
        pills: ['5GB NVMe', '5 EMAILS', 'FREE SSL'],
        priceNgn: 999,
        priceUsd: 0.75,
        billingPeriod: 'month',
        whmcsPid: 16,
      },
      {
        ...
        specs: {
          ...
          bandwidth: 'Unmetered Traffic',
          sla: '99.9% SLA',
          features: ['1 Hosted Website', 'Unlimited Business Emails', 'Free Wildcard SSL', 'cPanel Control Panel', 'Daily Cloud Backups'],
        },
        pills: ['PLUS', '1 SITE', 'FREE SSL'],
        priceNgn: 2499,
        priceUsd: 1.75,
        billingPeriod: 'month',
        whmcsPid: 4,
      ...
      },
      {
        ...
        pills: ['UNLIMITED', 'DEDICATED IP', 'VIP'],
        priceNgn: 12999,
        priceUsd: 8.99,
        billingPeriod: 'month',
        whmcsPid: 6,
